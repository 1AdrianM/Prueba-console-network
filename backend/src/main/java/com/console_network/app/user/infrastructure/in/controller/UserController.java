package com.console_network.app.user.infrastructure.in.controller;
import com.console_network.app.user.application.Service.UserService;
import com.console_network.app.user.infrastructure.out.dto.FollowRequest;
...
public class UserController {
 ...
 @GetMapping("/user/followers")
    public ResponseEntity<Optional<List<UserDto>>> getFollowers(@RequestBody UserDto user){
